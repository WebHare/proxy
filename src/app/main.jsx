...
class ClientRegistration extends React.Component
{
  ...
  render()
  {
    ...
    let lastactivechange = this.props.client.lastactivechange ? (new Date(this.props.client.lastactivechange)).toLocaleDateString('nl-NL', dtoptions) : '';
    ...
    return (
      <div style={styles.clientregistration}>
        <Paper style={styles.paper}>
          ...
          <div style={styles.heading}>Last registration: {lastreg} {lastactivechange ? "set: " + lastactivechange : ""}</div>
